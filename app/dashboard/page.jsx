...
import { getUser, reports, inventory } from "@/lib/api";
import {
  BookOpen,
  AlertTriangle,
  PlusCircle,
      ...
      <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 pb-4">
        ...
        {(role === "Administrator" || role === "Employee") && (
          <button
            ...
            className="hidden sm:flex items-center gap-2 px-6 py-3 bg-gradient-primary rounded-xl text-white font-bold text-sm btn-glow transition-transform hover:scale-105 active:scale-95 mt-4 sm:mt-0 shadow-lg relative z-0"
          >
